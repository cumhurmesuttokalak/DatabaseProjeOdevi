<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="middle_name" value="Middle Name" />
            ...
            <div class="mt-4">
                <x-jet-label for="tc_no" value="TC No" />
                <x-jet-input id="tc_no" class="block mt-1 w-full" type="text" name="tc_no" :value="old('tc_no')" required />
            </div>
